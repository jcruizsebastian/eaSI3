...
namespace eaSI3Web.Models
{
    public class StatisticsContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("User ID=OFVALENCIA\\pjimenez; Password=Solna1626.6;Initial Catalog=easi3;Data Source=LAPTOP104\\MSSQLSERVER01;Integrated Security=SSPI;timeout=40;Pooling=False;Connection Lifetime=1;");
        }
